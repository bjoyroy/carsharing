...
public class CarsharingScoringFunctionFactory implements ScoringFunctionFactory {
	...
	CarsharingScoringFunctionFactory( final Scenario sc, final DemandHandler demandHandler,
		...
		System.out.println("Guice::: CarsharingScoringFunctionFactory...");
		System.out.println("Guice::: CarsharingScoringFunctionFactory... DemandHandler Hash: " + demandHandler.hashCode());
		this.scenario = sc;
